...
import one.innovation.digital.beerStockManager.dto.QuantityDTO;
...
import static one.innovation.digital.beerStockManager.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    void whenGETIsCalledWithValidNameThenOkStatusIsReturned() throws Exception {
        ...
        //when
        when(beerService.getByName(beerDTO.getName())).thenReturn(beerDTO);
    ...
    void whenGETIsCalledWithoutRegisteredNameThenNotFoundStatusIsReturned() throws Exception {
        ...
        //when
        when(beerService.getByName(beerDTO.getName())).thenThrow(BeerNotFoundException.class);
    ...
    void whenGETListWithBeersIsCalledThenOkStatusIsReturned() throws Exception {
        ...
        //when
        when(beerService.getAll()).thenReturn(Collections.singletonList(beerDTO));
